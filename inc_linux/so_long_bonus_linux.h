...
/*   Updated: 2024/08/01 16:24:48 by gicomlan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void						ft_player_sprite_call(t_game *game, int width,
...
void						ft_right_sprite(t_game *game, int width,
								int height);
...
void						ft_draw_image_buffer(t_game *game, int width,
								int height, t_point sprite_pos);
...
void						ft_display_position(t_point start, t_point end,
								t_point z, t_point n);
